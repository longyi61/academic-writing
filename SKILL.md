...
Read your output once more before returning it, looking specifically for sentences that open with new information and for any word that could be cut without loss. Those two passes catch most of what separates a draft from publishable prose.
